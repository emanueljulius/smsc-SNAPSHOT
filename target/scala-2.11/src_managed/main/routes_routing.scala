...
// @LINE:8
private[this] lazy val controllers_Application_callBack1_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("send-sms"))))
private[this] lazy val controllers_Application_callBack1_invoker = createInvoker(
controllers.Application.callBack(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "callBack", Nil,"GET", """""", Routes.prefix + """send-sms"""))
...
def documentation = List(("""GET""", prefix,"""controllers.Application.index()"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """send-sms""","""controllers.Application.callBack()"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """assets/$file<.+>""","""controllers.Assets.at(path:String = "/public", file:String)""")).foldLeft(List.empty[(String,String,String)]) { (s,e) => e.asInstanceOf[Any] match {
...
case controllers_Application_callBack1_route(params) => {
   call { 
        controllers_Application_callBack1_invoker.call(controllers.Application.callBack())
   }
}
